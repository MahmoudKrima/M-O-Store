...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form enctype="multipart/form-data" method="POST" action="{{ route("admin.sliders.update",$slider->id) }}" role="form">
            @csrf
            @method("PUT")
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <input name="small_title_ar" value="{{ old('small_title_ar',$slider->small_title_ar) }}" type="text"
                    ...
                    <div class="form-group">
                        ...
                        @error('small_title_en')
                            <div class="right badge badge-danger">{{ $message = 'يجب ادخال الحقل' }}</div>
                        @enderror
                        <input name="small_title_en" value="{{ old('small_title_en',$slider->small_title_en) }}" type="text"
                    ...
                    <div class="form-group">
                        ...
                        @error('big_title_ar')
                            <div class="right badge badge-danger">{{ $message = 'يجب ادخال الحقل' }}</div>
                        @enderror
                        <input name="big_title_ar" value="{{ old('big_title_ar',$slider->big_title_ar) }}" type="text"
                    ...
                    <div class="form-group">
                        ...
                        @error('big_title_en')
                            <div class="right badge badge-danger">{{ $message = 'يجب ادخال الحقل' }}</div>
                        @enderror
                        <input name="big_title_en" value="{{ old('big_title_en',$slider->big_title_en) }}" type="text"
