            ...
            <nav class="limiter-menu-desktop p-l-45">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li>
                            <a href="product.html">{{__("front.Shop")}}</a>
                        </li>

                        <li class="label1" data-label1="hot">
                            <a href="shoping-cart.html">{{__("front.Features")}}</a>
                        </li>
                        ...
                        <li>
                            <a
                                href="{{ app()->getLocale() == 'ar' ? url('local?local=en') : url('local?local=ar') }}">{{ app()->getLocale() == 'ar' ? 'English' : 'العربية' }}</a>
                        </li>
                    </ul>
                </div>
